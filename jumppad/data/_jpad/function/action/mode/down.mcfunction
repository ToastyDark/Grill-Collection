...
# Switch Mode to Copy
execute if items entity @s weapon.mainhand slime_ball[minecraft:custom_data~{jpad_mode:delete}] run return run item modify entity @s weapon.mainhand _jpad:set_mode/copy

# Switch Mode to Print
execute if items entity @s weapon.mainhand slime_ball[minecraft:custom_data~{jpad_mode:copy}] run return run item modify entity @s weapon.mainhand _jpad:set_mode/print

# Switch Mode to Gravity
execute if items entity @s weapon.mainhand slime_ball[minecraft:custom_data~{jpad_mode:print}] run return run item modify entity @s weapon.mainhand _jpad:set_mode/gravity
