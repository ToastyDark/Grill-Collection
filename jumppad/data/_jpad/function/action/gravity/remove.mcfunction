...
execute if score $current_gravity temp matches 0..10 unless score $current_gravity temp matches ..10 run return run execute as @p run function _jpad:msg/error_sound
execute if score $current_gravity temp matches -7..-1 unless score $current_gravity temp matches -7.. run return run execute as @p run function _jpad:msg/error_sound
# Remove 1
