...
$tellraw @a ["",{selector:"@s[scores={id=$(inviter_id)}]"},{text:" has invited you to play ctf!",bold:true,color:"green",click_event:{action:"run_command",command:"/trigger tp.$(ctf)"},hover_event:{action:"show_text",value:[{text:"Click to Join",color:"gray"}]}}]
