...
# Summon Interaction
summon armor_stand ~ ~ ~ {Tags:["jpad_marker","jpad_unassigned"],Small:1b,Marker:1b,Invulnerable:1b,Invisible:1b,Passengers:[{id:"minecraft:interaction",width:1.2f,height:1f,Tags:["jpad_int","jpad_unassigned"]}]}
